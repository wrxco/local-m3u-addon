...
- Users should drop in a standard UTF-8 M3U/M3U8 playlist with `#EXTINF` metadata followed by playable URLs. See `docs/playlist-format.md`.
...
This folder is intended to be the publishable project. Generated local artifacts such as `reports/`, `logs/`, `.DS_Store`, and unrelated scratch docs are ignored.
